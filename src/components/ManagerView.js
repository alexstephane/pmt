...
//                       <Button onClick={this.salespersonList} variant="primary">
//                         {" "}
//                         All Sales People
//                       </Button>
//                       {"  "}
//                       <Button onClick={this.prospectList} variant="primary">
//                         {" "}
//                         All Prospects
//                       </Button>
//                       {"  "}
//                       <Button onClick={this.activitiesList} variant="primary">
//                         {" "}
//                         All Activities
//                       </Button>
//                     </ButtonGroup>
...
//               deleteRep={this.props.deleteRep}
//             />
//           ) : null}
